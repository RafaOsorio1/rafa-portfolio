    ...
    >
      <div className="h-44 overflow-hidden relative">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to top, #0C0C1A 10%, transparent 60%)' }}
        />
        <div className="absolute top-3 right-3">
          <span
            ...
            style={{
              background:
                project.status === 'production' ? 'rgba(0,255,128,0.15)' : 'rgba(255,200,0,0.15)',
      ...
      <div className="p-5 space-y-3">
        <div className="flex items-start justify-between gap-2">
          <h3 className="font-bold text-lg" style={{ fontFamily: "'Exo 2', sans-serif" }}>
            {project.title}
          </h3>
        ...
        {'collaboration' in project && project.collaboration && (
          <div className="text-[10px] font-mono py-0.5" style={{ color: project.accent }}>
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {project.tech.length > 4 && (
            <span className="text-xs font-mono px-1.5 py-0.5" style={{ color: '#64748B' }}>
              +{project.tech.length - 4}
            </span>
          )}
        </div>
        <div
          className="flex items-center gap-1.5 text-xs font-mono pt-1"
