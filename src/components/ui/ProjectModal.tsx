    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 z-10 flex items-center gap-2 px-4 py-3" style={{ background: "#0C0C1A", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <button onClick={() => setIsMinimized(!isMinimized)} className="w-3 h-3 rounded-full hover:opacity-70 transition-opacity" style={{ background: "#FFBD2E" }} />
          <button onClick={() => { setIsMaximized(!isMaximized); setIsMinimized(false); }} className="w-3 h-3 rounded-full hover:opacity-70 transition-opacity" style={{ background: "#28CA41" }} />
