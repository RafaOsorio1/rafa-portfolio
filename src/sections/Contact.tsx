    ...
    <>
      <section id="contact" className="py-28 px-6">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <h2 className="text-4xl font-black" style={{ fontFamily: "'Exo 2', sans-serif" }}>
            {t('contact.title')}
          </h2>
          ...
          <div
            className="text-left rounded-xl p-6 font-mono text-sm space-y-3"
            style={{ border: '1px solid rgba(0,229,255,0.2)', background: 'rgba(0,229,255,0.02)' }}
          >
            ...
            <div className="pl-4 space-y-2" style={{ color: '#64748B' }}>
              <div>
                →{' '}
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=hi@rafaosorio.dev"
                  target="_blank"
              ...
              <div>
                →{' '}
                <a
                  href="https://www.linkedin.com/in/rafaosoriodev"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-foreground transition-colors"
                  style={{ color: '#00E5FF' }}
                >
                  linkedin.com/in/rafaosoriodev
                </a>
              </div>
              <div>
                →{' '}
                <a
                  href="https://github.com/RafaOsorio1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-foreground transition-colors"
                  style={{ color: '#00E5FF' }}
                >
                  github.com/RafaOsorio1
                </a>
              </div>
            </div>
          ...
          <div className="relative inline-block mt-4">
            {showOptions && (
              <div
                className="absolute left-1/2 -translate-x-1/2 bottom-full mb-3 w-48 rounded-lg overflow-hidden shadow-2xl animate-fade-up z-50 flex flex-col"
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-3 text-sm text-left hover:bg-[rgba(0,229,255,0.1)] transition-colors border-b border-[rgba(255,255,255,0.05)] text-foreground flex items-center gap-2"
                ...
                <a
                  href={`mailto:${email}`}
                  className="px-4 py-3 text-sm text-left hover:bg-[rgba(0,229,255,0.1)] transition-colors text-foreground flex items-center gap-2"
                  onClick={() => setShowOptions(false)}
                >
                  💻 Default App
                </a>
      ...
      >
        <div className="max-w-6xl mx-auto space-y-1">
          <p className="font-mono text-xs" style={{ color: '#2D3748' }}>
